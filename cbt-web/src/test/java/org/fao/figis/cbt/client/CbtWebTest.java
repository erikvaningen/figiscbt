package org.fao.figis.cbt.client;
 ...
 * details.
 */
public class CbtWebTest extends GWTTestCase {
	...
	public String getModuleName() {
		return "org.fao.figis.cbt.cbt-webJUnit";
	}
	...
	public void testGreetingService() {
		...
		target.setServiceEntryPoint(GWT.getModuleBaseURL() + "cbt-web/greet");
